...
namespace AlgLab3
{
    class Exercise2
    {
        ...
        public static int[] Un(int n,int k, int[,] arrays)
        {
        ...
        public static int[,] GetRandomArrays(int k, int n)
        {
            ...
            for (int i = 0; i < k; i++)
            {
                ...
                for (int j = 0; j < n; j++)
                {
                    nTempArray[j] = rand.Next(-100, 100);
                }
        ...
        public static void WriteArrayWithMessage(int[] array,string message="")
        {
            Console.Write("\n"+message);
